            ...
            <div className="row featurette">
              <div className="text-white col-md-7 order-md-2">
                ...
                <p className="lead">
                  ...
                  habitat or source of food isn’t why they're going extinct.
                  They are facing a constant threat of poaching for their horns.
                  There is only 27,000 rhinos left in the world.
                </p>
              </div>
              <div className="col-md-5 order-md-1">
                <Image
